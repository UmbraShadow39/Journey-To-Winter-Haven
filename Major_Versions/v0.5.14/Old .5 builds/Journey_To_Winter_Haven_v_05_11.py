...
def reset_between_rounds(hero):
    ...
    # Charismatic Speaker — strip the per-fight +2 ATK buff
    if "charismatic_speaker" in getattr(hero, "titles", set()):
        hero.min_atk = max(1, hero.min_atk - 2)
        hero.max_atk = max(hero.min_atk, hero.max_atk - 2)
...
def _make_weapon_core(corrupted=False):
    ...
    if corrupted:
        ...
        d_stats = {"atk_min": WEAPON_CORE_ONEHANDED_STATS["atk_min"] + 6,
                   "atk_max": WEAPON_CORE_ONEHANDED_STATS["atk_max"] + 6,
                   "defence": WEAPON_CORE_ONEHANDED_STATS["defence"] - 2}
        o_stats = {"atk_min": WEAPON_CORE_TWOHANDED_STATS["atk_min"] + 8,
                   "atk_max": WEAPON_CORE_TWOHANDED_STATS["atk_max"] + 8,
                   "defence": WEAPON_CORE_TWOHANDED_STATS["defence"] - 3}
...
SKILL_DEFS = {
    ...
    "heal": {
        ...
        "rank_descs": {
            ...
            5: "Restore 40% max HP. Cures all status effects except psychic. 3 AP",
        },
    },
    "war_cry": {
        "name": "War Cry",
...
def fallen_warrior_moral_choice(warrior, fallen=None):
    ...
    print()
    print(wrap(
        "Then it stops drifting toward you."
    ))
    print()
    input("Press Enter...")
    print()
    ...
    print(wrap(
        ...
        "The red light steadies again almost immediately, but for a moment "
        "the pull faltered."
    ))
    print()
    input("Press Enter...")
    ...
    print()
    print(wrap(
        "You watch it happen. The crowd watches too — but they're cheering. "
        "They've seen this before. They don't know what they're seeing."
    ))
    print()
    input("Press Enter...")
    print()
    ...
    while True:
        ...
        if choice == "1":
            ...
            print()
            print(wrap(
                "The Fallen Warrior breathes his last. "
            ...
            if fallen is not None:
                fallen.hp = 0
            print(wrap(
                "The Fallen Warrior's eyes go hollow. Whatever was left of him "
                "goes with the essence. He collapses completely."
            ))
            print()
            input("Press Enter...")
            print()
...
def battle_inner(warrior, enemy, skip_rest=False, round_num=0):
    ...
    try:
        ...
        # Charismatic Speaker mastery — +2 ATK for the entire fight
        if "charismatic_speaker" in getattr(warrior, "titles", set()):
            warrior.min_atk += 2
            warrior.max_atk += 2
            print(wrap("🎤 Charismatic Speaker: Your presence surges — +2 ATK for this fight!"))
        ...
        while warrior.is_alive() and enemy.is_alive():
            ...
            if warrior_turn:
                ...
                if not enemy.is_alive():
                    ...
                    # 1. LOOT DROP — skip for Fallen Warrior (handled inside moral choice)
                    ...
                    # 2. XP — skip for Fallen Warrior (handled inside moral choice)
                    if enemy.name != "Fallen Warrior":
